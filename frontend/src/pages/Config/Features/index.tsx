...
const PAGE_LABEL_KEYS: Record<string, string> = {
  ...
  'customer-revenue': 'nav.customerRevenue',
  'customer-gross-profit': 'nav.customerGrossProfit',
  'high-margin-penetration': 'nav.highMarginPenetration',
  'repeat-order': 'nav.repeatOrder',
  'customer-expansion': 'nav.customerExpansion',
  ...
  'avg-category-per-customer': 'nav.avgCategoryPerCustomer',
