...
| --- | --- | --- |
| **Active Transacting** | Semua pelanggan yang bertransaksi di periode berjalan, termasuk yang baru pertama kali. | `Acquisition + Active Customer + Reactivated` |
| **Existing Active** | Pelanggan yang sudah pernah bertransaksi sebelumnya (bukan pelanggan baru) dan masih aktif bertransaksi di periode berjalan. | `Active Customer + Reactivated` |
| **Customer Base (Addressable)** | Pelanggan yang sudah pernah bertransaksi dan belum melewati ambang dormant, masih bisa dijangkau atau ditindaklanjuti. | `Active Customer + Reactivated + Lapsed` |
| **Total Customer Base** | Seluruh pelanggan yang pernah bertransaksi, apa pun status terkininya, termasuk yang sudah dormant. | `Active Customer + Reactivated + Lapsed + Dormant` |
