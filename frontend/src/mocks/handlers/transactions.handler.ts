...
const mockInvoices: InvoiceRow[] = [
  {
    ...
    customer: { id: 1, code: 'CUST-001', name: 'PT Maju Bersama', business_unit: 'distribution' },
  ...
  },
  {
    ...
    customer: { id: 4, code: 'CUST-004', name: 'PT Industri Mandiri', business_unit: 'intercompany' },
  ...
  },
  {
    ...
    customer: { id: 2, code: 'CUST-002', name: 'CV Teknologi Nusantara', business_unit: 'distribution' },
    company: { id: 1, name: 'PT ABC Sejahtera' },
  ...
  },
  {
    ...
    customer: { id: 5, code: 'CUST-005', name: 'PT Proyek Infrastruktur', business_unit: 'project' },
    company: { id: 1, name: 'PT ABC Sejahtera' },
  ...
  },
  {
    ...
    customer: { id: 4, code: 'CUST-004', name: 'PT Industri Mandiri', business_unit: 'project' },
    company: { id: 2, name: 'PT XYZ Mandiri' },
  ...
  },
  {
    ...
    customer: { id: 3, code: 'CUST-003', name: 'PT Solusi Digital', business_unit: 'e_commerce' },
    company: { id: 1, name: 'PT ABC Sejahtera' },
